      ...
      * {
      ...
      @media only screen and (max-width:768px) {
          ...
          color: #fff
            ...
            background-image: url(<?= base_url('image/dev2/banner-tablet.png'); ?>);
            background-size: cover;
            background-repeat: no-repeat;
            height: 1000px;
            margin: 0;
        ...
        .logo_lmkn{
          ...
          color: #fff
            ...
            body{
              -webkit-background-image: linear-gradient(#061352, #042ca5);
            background-image: url(<?= base_url('image/dev2/banner-image2-copy.jpeg'); ?>);
...
<div class="col-md-12">
                <div class="row">
                  <div class="col-md-9 sisi-kiri" style="height: 720px;">
                    <div class="row">
            ...
            <div class="col-md-3 ">
              <!-- Image and text -->
                    <nav class="navbar navbar-light logo2">
                    <img src="<?= base_url('image/dev2/group.png'); ?>" class="logo_lmkn" alt="">
                    </nav>
    <div class="container justify-content-center">
              <img src="<?= base_url('image/dev2/LMKN.png'); ?>" class="d-inline-block align-top  " style="margin-left:40%; width: 55%; margin-top: 100px;" alt="">
