             ...
             <span class="col-xs-12 col-sm-12 col-md-12 hidden-lg">
                 <form class="form-search" method="post" action="">
                     <div class="input-group">
                        <select class="form-control" name="tanggalsubscriptionlabel" id="tanggal" required="#ada1">
        ...
        <form class="form-inline pull-right" method="post" action="">
            <select class="form-control" name="tanggalsubscriptionlabel" id="tanggal" required="#ada1">
                ...
                for($i = 0; $i<50;$i++ ){
                    ...
                    $tahun = substr($tgl ,0,4);
                    $hasilbulan = $bulan.' '.$tahun;
                    if($hasilbulan === $tanggal_awal){
                        echo '<option id="ada1" class="active" value="'.$tgl.'">'.$hasilbulan.'</option>';
                    }
                    else{
                        echo '<option id="ada1"  value="'.$tgl.'">'.$hasilbulan.'</option>';
                    }
                }?>
            </select>
...
foreach ($getTypeSubscription as $subscription){
    if($subscription->subscription == "FREE"){
        ...
        $this->load->view('label/subscription/grafiks/'.str_replace(' ','',$subscription->subscription));
