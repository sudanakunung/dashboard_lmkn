...
if(empty($infoGrafikView)){ ?>
    <div class="row">
        <div class="col-md-6 col-lg-6 hidden-xs hidden-sm">
            <div class="panel panel-danger dashboard-panel" style="background-color: transparent">
                ...
                <div class="panel-body" style="text-align: center; text-transform: uppercase;font-weight: bold">Jumlah User View Lagu Anda</div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <canvas id="myChartlabel_view">

            </canvas>
        </div>
    </div>
    <script type="text/javascript">
        var ctx = document.getElementById("myChartlabel_view");
    ...
    foreach ($infoGrafikView as $info) :
        $genders[] = $info->gender;
        $jumlahs[] = $info->jumlah;
    ...
    <div class="row">
        ...
        <!--            tag untuk chart-->
        <div class="col-md-6">
            <canvas id="myChartlabel_view" style="width: 20px; height: 50px; margin-bottom: 20px; margin-top: 40px">
