<ul class="nav">
    ...
    //admin lkm//
    buat_menu("songadmininstitution","music","Music",array("admininstitution"));
    // buat_menu("recordingadmininstitution","headphones","Recording",array("admininstitution"));
    buat_menu("vieweradmininstitution","eye-open","Viewer",array("admininstitution"));
    buat_menu("likeadmininstitution","thumbs-up","Like",array("admininstitution"));
    // buat_menu("banneradmininstitution","flag","Banner",array("admininstitution"));
    buat_menu("songrequestadmininstitution","bullhorn","Song Request",array("admininstitution"));
    ...
    if($this->session->userdata('admincountry') == "" || $this->session->userdata('admincountry') == "ind"){
        ...
        if(isset($permission)){
            if($permission->canRead == true){
                buat_menu("recordingadmin","headphones","Counter Lagu",array("admin"));
            }
        }
    }
