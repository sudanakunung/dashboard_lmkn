...
<div class="card mb-20">
	...
	if($sessionLangCode <> 'phi'){
		buka_tabel(array("Composer ID", "Composer Name", "Institution", "Referral"), $action = true);
		...
		foreach ($dataComposer as $composer){
			...
			isi_tabel_admin(++$start, array($composer->composerId, $composer->name, $composer->lembaga, $ikon), base_url('composer/edit'), base_url('composer/hapus_composer'), $composer->composerId, true, true);
		}
