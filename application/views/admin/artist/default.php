<?= $this->session->flashdata('sukses_aksi'); ?>
...
<div class="card mb-20">
    ...
    if($sessionLangCode <> 'phi'){
        buka_tabel(array("ArtistId", "Name", "Institution", "Referral","User Id"), $action = true);
        ...
        foreach ($dataArtist as $artist){
            ...
            isi_tabel_admin(++$start, array($artist->artistId, $artist->name, $artist->lembaga, $ikon, $artist->userId), base_url('artistadmin/edit'), base_url('artistadmin/hapus'), $artist->artistId, true, true);
        }
