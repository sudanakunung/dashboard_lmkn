...
if($this->session->userdata('admincountry') == "" || ($this->session->userdata('roleId') == "1" && $this->session->userdata('admincountry') == "ind")){
    ...
    buat_combobox("ADMIN FOR", "langCode", array(array("cap" => "LMKN", "val" => "ind"), array("cap" => "FILSCAP", "val" => "phi")), $data['langCode'], '4');

    $typeAdmin = array(array("cap"=>"Admin LMKN","val"=>1),array("cap"=>"Admin LMK","val"=>9),array("cap"=>"Artist","val"=>0),array("cap"=>"Label","val"=>2),array("cap"=>"Content Provider","val"=>7),array("cap"=>"Composer","val"=>3));
