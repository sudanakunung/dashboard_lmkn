...
if ($this->session->userdata('admincountry') == 'ind') {
    ...
    $typeAdmin = array(array("cap"=>"Admin LMKN/FILSCAP","val"=>1),array("cap"=>"LMK","val"=>9),array("cap"=>"Artist","val"=>0),array("cap"=>"Label","val"=>2),array("cap"=>"Content Provider","val"=>7),array("cap"=>"Composer","val"=>3));
}
