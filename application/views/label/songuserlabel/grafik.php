...
<div class="row">
    ...
    <div class="tab-content">
        <div id="homes" class="tab-pane fade in active">
            <br/>
            <?php $this->load->view('composer/songusercomposer/grafiks/recorder'); ?>
        </div>
        <div id="menus1" class="tab-pane fade">
            <br/>
            <?php $this->load->view('composer/songusercomposer/grafiks/liker'); ?>
        </div>
        <div id="menus2" class="tab-pane fade">
            <br/>
            <?php $this->load->view('composer/songusercomposer/grafiks/viewer'); ?>
        </div>
    </div>
</div>