...
$total_user_view = array_sum($statistikViewer[1]);
$genders = $statistikViewer[0];
$jumlahuserids = $statistikViewer[1];
?>
<div class="row">
    <div class="hidden-xs hidden-sm col-md-6 col-lg-6">
        <div class="panel panel-info dashboard-panel">
            <div class="panel-heading" style="font-size: 70px; line-height: 70px">
                ...
                <span class="pull-right"><?php echo $total_user_view; ?></span>
            </div>
            <div class="panel-body" style="text-align: center; text-transform: uppercase;font-weight: bold">Jumlah User View Lagu Anda<br/></br/>
                <div class="col-md-12">
    ...
    <!--    buat chart-->
    <div class="col-md-6">
        <canvas id="myChartView" style="width: 20px; height: 50px; margin-bottom: 20px; margin-top: 40px"></canvas>
    </div>
</div>
...
if(empty($genders)){ ?>
    <script type="text/javascript">
        var ctx = document.getElementById("myChartView");
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [<?php for($i=0;$i<count($jumlahuserids);$i++){
                        echo '"' . number_format(($jumlahuserids[$i]/$total_user_view) * 100, 2) . '",';}?>],
                    backgroundColor: [
