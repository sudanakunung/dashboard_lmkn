...
<form method="post" action="<?= base_url('songbankadminarranger/aksitambah'); ?>">
    ...
    <div class="row mb-15">
        <?php
        $arrangername = array();
        foreach ($getArrangerData as $arranger) {
                $arrangername[] = array("cap" => $arranger->arranger, "val" => $arranger->arrangerId);
        }
        buat_combobox("Please choose a Arranger", "arrangerName", $arrangername, "", $lebar = '4');
        ?>
    </div>
...
<script type="text/javascript">
    $("#arrangerName").chosen({no_results_text: "Tidak ditemukan....!"});
