...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-11">
    ...
    <ul class="nav navbar-nav visible-xs" style="margin-top: 20px;">
        ...
        //admin lkm//
        buat_menu("songadminlmk","music","Music",array("institution"));
        // buat_menu("recordingadmincomposer","headphones","Recording",array("institution"));
        buat_menu("vieweradminlmk","eye-open","Viewer",array("institution"));
        buat_menu("likeadminlmk","thumbs-up","Like",array("institution"));
        // buat_menu("composerlist","cd","Composer",array("institution"));
        // buat_menu("banneradmincomposer","flag","Banner",array("institution"));
        buat_menu("songrequestadminlmk","bullhorn","Song Request",array("institution"));
