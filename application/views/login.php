...
<head>
    <title>Login to Musicpreneurship</title>
...
<center>
    <nav class="navbar navbar-default visible-xs" style="background-color: transparent; border-width: 0px; color: white">
            <span>
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="d-none d-sm-block col-md-9 sisi-kiri" style="height: 720px;">
                            <div class="row">
                                <div class="col-md-4" style="margin-left: 165px; margin-top: 50px;">
                                    <img src="<?= base_url('image/webpage-03.png'); ?>" class="img-fluid" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 login-box">
                            ...
                            <div class="container justify-content-center content-login-box">
                                <?php 
                                if($this->session->userdata('langCode') == 'ind'){
                                    $namaGambar = 'LMKN.png';
                                } else {
                                    $namaGambar = 'FILSCAP_B.png';
                                }
                                ?>
                                <img src="<?= base_url('image/dev2/'.$namaGambar.''); ?>" class="align-top d-none d-sm-block" style="margin-left:46%; width: 55%; margin-top: 50px; margin-bottom: 58px;" alt="">

                                <div class="card " id="masuk">
                                    
                                    <div class="row d-block d-sm-none img-logo">
                                        <img src="<?= base_url('image/webpage-03.png'); ?>" class="align-top" style="width: 65px; float: left;" alt="">

                                         <?php 
                                        if($this->session->userdata('langCode') == 'ind'){
                                            $namaGambarMobile = 'LMKN.png';
                                        } else {
                                            $namaGambarMobile = 'FILSCAP.png';
                                        }
                                        ?>

                                        <img src="<?= base_url('image/dev2/'.$namaGambarMobile.''); ?>" class="align-top" style="width: 80px; float: right;" alt="">
                                    </div>
                                    ...
                                    <form class="form-horizontal" style="margin: 10px; padding: 20px; " method="post" action="">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control bg-transparent" name="password" id="exampleInputPassword1" placeholder="Password" required>
                                        </div>
                                    ...
                                    <div class="copyright d-flex justify-content-center ">
                                        <p>Mydiowork Technology | Copyright <?= date('Y'); ?></p>
                                    </div>
